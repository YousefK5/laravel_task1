...
@section('content')
    ...
    <div class="container mx-auto mt-4">
        ...
        <div class="row m-5">
            <div class="col-md-6">
                <h1 style="color:#f03d4f;">Books In Trash</h1>
            </div>
            <div class="col-md-6">
                {{-- <a href="/deleteAll"><button type="button" class="btn btn-primary btn-lg">Empty Trash</button>
                </a> --}}
            </div>
        </div>
        <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    {{ $book['image'] }}"
                        ...
                        <div class="card-body">
                            ...
                            <a href="restore/{{ $book['id'] }}" class="btn mr-2"><i class="fas fa-edit"></i> Restore</a>
